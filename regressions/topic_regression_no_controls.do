...
esttab est1 est2 est3 est4 using "./regressions/Topic Regressions No Controls.tex", replace booktabs substitute(\_ _) ///
	...
	keep(event_14 event_15 event_17 event_18) ///
